...
However, on a site like mine the bottleneck is always going to be the images and videos. For the images I'm using Astro's built in image optimizer that creates different size and qualities for me at build time. The videos I have to manually fine-tune with the help of [Handbrake](https://handbrake.fr/).
...
Another thing that's done purely through CSS is the hamburger menu you get on mobile sizes. It's done with the strategic usage of a checkbox and sibling selectors. Oh, if my 14-year-old self had access to these fancy "new" CSS modules. It was a different time for CSS, and many other things.
...
## For the future
This is an on-going project and when the next time you visit things will be different, hopefully improved. And, if you are reading this in the future, and the website is completely different, just know that the chapter started somewhere here.